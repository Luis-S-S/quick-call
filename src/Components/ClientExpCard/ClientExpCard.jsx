  ...
  return (
    <div className="client-card">
      <div className="client-card__header">
        <img className="client-card__profile" src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/cd/Black_from_a_camera.jpg/1200px-Black_from_a_camera.jpg" alt="profile" />
